...
Write-host ========= Veeam Applications ==============
 

Write-host Enabling TCP Port 9392 for Veeam Backup and Replication Service

New-NetFirewallRule -DisplayName "Allow inbound TCP Port 9392" –Direction inbound –LocalPort 9392 -Protocol TCP -Action Allow
 
New-NetFirewallRule -DisplayName "Allow outbound TCP Port 9392" –Direction outbound –LocalPort 9392 -Protocol TCP -Action Allow


Write-host Enabling TCP Port 9393 for Veeam Backup Catalog Service

New-NetFirewallRule -DisplayName "Allow inbound TCP Port 9393" –Direction inbound –LocalPort 9393 -Protocol TCP -Action Allow
 
New-NetFirewallRule -DisplayName "Allow outbound TCP Port 9393" –Direction outbound –LocalPort 9393 -Protocol TCP -Action Allow
